            ...
            <form class="form-horizontal" method="post" action="{{url('/addPatient')}}">
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <textarea class="form-control" name="symptoms"   placeholder="e.g. coughing"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                            <textarea class="form-control" name="allergies"  placeholder="e.g pollen grains"></textarea>
                        </div>
                    </div>
                </div>
